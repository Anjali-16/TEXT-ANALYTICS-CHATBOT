...
def load_pdf_docs(path, chunksize=1000, overlap=100):
    ...
    return pages
#################################################################################################
def split_docs_into_chunks(docs, chunksize=512, overlap=20):
...
def main():
    ...
    chunks = split_docs_into_chunks(docs, chunksize=512, overlap=20) ### here chunk size will help us tuning.
    #print(type(chunks))
    #print(len(chunks))
